...
module.exports = __webpack_require__(/*! /Users/tsaotingwei/Documents/GitHub/NTUT_patent_site/src/main.ts */"zUnb");
...
/* harmony import */ var src_app_shared_consts_routing_path_const__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/shared/consts/routing-path.const */ "2nli");
...
/* harmony import */ var ng_zorro_antd_form__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ng-zorro-antd/form */ "wf2+");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var ng_zorro_antd_grid__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ng-zorro-antd/grid */ "tYkK");
...
function LoginComponent_nz_form_item_24_Template(rf, ctx) { if (rf & 1) {
...
class LoginComponent {
    constructor(fb, messageService, loadingService, router) {
        this.fb = fb;
        ...
        this.currentType = LoginType.login;
        // TODO: hardcode 帳密
        this.account = {
    ...
    onArrowClick() {
        var _a;
        const loginPos = (_a = document.getElementById('login')) === null || _a === void 0 ? void 0 : _a.offsetTop;
        window.scrollTo({ top: loginPos, behavior: 'smooth' });
    }
    onTypeClick(type) {
    ...
    onLoginClick() {
        ...
        // 驗證帳密
        if (((_a = this.validateForm.get('email')) === null || _a === void 0 ? void 0 : _a.value) !== this.account.email ||
            ((_b = this.validateForm.get('userWord')) === null || _b === void 0 ? void 0 : _b.value) !== this.account.userWord) {
            this.messageService.errorModal('電子信箱或密碼輸入錯誤！');
            return;
        }
        // TODO: 假讀取
        this.loadingService.loading(true);
        sessionStorage.setItem("Token" /* TOKEN */, 'fakeToken');
        setTimeout(() => {
            this.router.navigate([src_app_shared_consts_routing_path_const__WEBPACK_IMPORTED_MODULE_2__["ROUTING_PATH"].MAIN_PAGE]);
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 42, vars: 13, consts: [[2, "position", "relative"], [1, "background-star"], [1, "background-mountain"], [1, "welcome"], [1, "down-arrow", 3, "click"], ["src", "./assets/image/down-arrow.png", "alt", ""], ["id", "login"], [1, "login-form"], [1, "w-100"], ["nzCentered", "", 3, "nzTabBarStyle"], ["nzTitle", "\u7BA1\u7406\u8CC7\u6599\u5EAB"], ["nzTitle", "\u4EBA\u624D\u8CC7\u6599\u5EAB"], ["nzTitle", "\u5B78\u754C\u8CC7\u6599\u5EAB"], [1, "text-primary", "text-center"], [1, "d-flex", "justify-content-evenly", "mb-2"], [1, "select-login-btn", "text-white", 3, "click"], ["src", "./assets/image/login.svg", "width", "45", "alt", "", 1, "login-img"], [1, "select-register-btn", "text-white", 3, "click"], ["nz-form", "", "nzNoColon", "", 3, "nzLayout", "formGroup"], [4, "ngIf"], ["nzFor", "email", 1, "login-label"], [3, "nzErrorTip"], ["nz-input", "", "placeholder", "\u8ACB\u8F38\u5165\u96FB\u5B50\u4FE1\u7BB1", "nzBorderless", "", "formControlName", "email", 1, "border-bottom", "border-2", "text-white"], ["nzFor", "userWord", 1, "login-label"], ["nz-input", "", "placeholder", "\u8ACB\u8F38\u5165\u5BC6\u78BC", "nzBorderless", "", "formControlName", "userWord", "type", "password", 1, "border-bottom", "border-2", "text-white"], [1, "btn-group"], [1, "text-light-gray", "d-inline-block", "mb-4", "mb-md-0", 3, "ngStyle"], [1, "login-btn", 3, "mercSize", "mercWidth", "click"], [1, "login-text"], ["src", "./assets/image/login-btn.svg", "alt", "", 1, "login-btn-img"], ["nzFor", "name", 1, "login-label"], ["nz-input", "", "placeholder", "\u8ACB\u8F38\u5165\u59D3\u540D", "nzBorderless", "", "formControlName", "name", 1, "border-bottom", "border-2", "text-white"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function LoginComponent_Template_a_click_5_listener() { return ctx.onArrowClick(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function LoginComponent_Template_a_click_17_listener() { return ctx.onTypeClick(ctx.loginType.login); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function LoginComponent_Template_a_click_20_listener() { return ctx.onTypeClick(ctx.loginType.register); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function LoginComponent_Template_merc_button_click_38_listener() { return ctx.onLoginClick(); });
...
/* harmony import */ var src_app_shared_consts_routing_path_const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/shared/consts/routing-path.const */ "2nli");
...
/* harmony import */ var _nz_nz_modules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./nz/nz.modules */ "8g6U");
...
SharedModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({ factory: function SharedModule_Factory(t) { return new (t || SharedModule)(); }, imports: [[
            ...
            _nz_nz_modules__WEBPACK_IMPORTED_MODULE_1__["NgZorroAntdModule"],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](SharedModule, { imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
        _nz_nz_modules__WEBPACK_IMPORTED_MODULE_1__["NgZorroAntdModule"],
        merc_lib__WEBPACK_IMPORTED_MODULE_2__["MercLibModule"]], exports: [_nz_nz_modules__WEBPACK_IMPORTED_MODULE_1__["NgZorroAntdModule"],
        merc_lib__WEBPACK_IMPORTED_MODULE_2__["MercLibModule"]] }); })();
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 2, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [merc_lib__WEBPACK_IMPORTED_MODULE_1__["LoadingComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAuY29tcG9uZW50LnNjc3MifQ== */"] });
...
/* harmony import */ var _impact_patent_login_login_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./impact-patent/login/login.component */ "I8mG");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [{ provide: ng_zorro_antd_i18n__WEBPACK_IMPORTED_MODULE_3__["NZ_I18N"], useValue: ng_zorro_antd_i18n__WEBPACK_IMPORTED_MODULE_3__["zh_TW"] }], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        _impact_patent_login_login_component__WEBPACK_IMPORTED_MODULE_10__["LoginComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_1__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"],
...
/* harmony import */ var _impact_patent_login_login_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./impact-patent/login/login.component */ "I8mG");
/* harmony import */ var _shared_consts_routing_path_const__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shared/consts/routing-path.const */ "2nli");
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | impact-patent-main-page-main-page-module */ "impact-patent-main-page-main-page-module").then(__webpack_require__.bind(null, /*! ./impact-patent/main-page/main-page.module */ "FhBq")).then(m => m.MainPageModule),
